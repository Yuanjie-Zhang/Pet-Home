...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(route('cats')); ?>">Cats</a></li>
            <li><a href="<?php echo e(route('dogs')); ?>">Dogs</a></li>
            <li><a href="<?php echo e(route('forum')); ?>">Forum</a></li>
            <li><a href="<?php echo e(route('pets.create')); ?>">Post</a></li>
        </ul>
...
<?php /**PATH /home/ubuntu/Pet-Home/resources/views/pets/home.blade.php ENDPATH**/ ?>